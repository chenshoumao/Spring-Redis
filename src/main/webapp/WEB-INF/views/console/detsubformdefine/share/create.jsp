...
<head>
	...
	<script src="${pageContext.request.contextPath}/scripts/console/detShareSubformdef/create.js" type="text/javascript"></script>
		...
		<form id="form1" method="post">
			<div class="easyui-tabs" style="width:100%; height:auto" id="tabpanel">
				...
				<div title="表单头" style="padding:10px" id="tab2">
					<textarea id="htmlHead" name="htmlHead" style="width:100%; height:400px"></textarea>
				</div>
				...
				<div title="属性" style="padding:10px" id="tab4">
					<table class="prop_table">
				 		<tr>
				 			<th>子表单名称(<span style="color:red">*</span>)</th>
