...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	src="${pageContext.request.contextPath}/scripts/console/datSystemMeta/index.js"></script>
<style type="text/css">
.fitem label {
...
<body class="easyui-layout">
		 <div class="easyui-layout" data-options="fit:true">   
            <div data-options="region:'west',split:true,title:'元数据类目'" style="width:180px">
				<jsp:include page="./systemMetaCata.jsp" />
            </div>  
	         <div data-options="region:'center'" class="center">
				<div id="tabs" class="easyui-tabs" fit="true" border="false">
					<iframe  id="iframe_systemMeta"src="${pageContext.request.contextPath}/console/systemMeta/getSystemMetas.xsp" 
