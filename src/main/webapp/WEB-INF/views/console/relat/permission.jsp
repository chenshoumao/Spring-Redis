...
var rows = $('#dg').datagrid('getChecked');
		...
		$("#checkedRoleId").val(rows[0].roleNum);
$('#dlg_permission').dialog('open');
$.ajax({
	  type: 'post' ,
	  url: '${pageContext.request.contextPath}/console/role/member/getRoleMenu.action' ,
	  dataType:'json' ,
	 	data:{
	 	roleId:rows[0].roleNum
	 	},
...
//保存角色的权限
	  function save_permission(){
          ...
          $.ajax({    
            ...
            data:{
            "menuItemIds":ids,
            "roleId":$("#checkedRoleId").val()
            },  
            dataType : "json",  
            url: "${pageContext.request.contextPath}/console/role/member/addRoleMenuItem.action",  
            error: function () {  
...
<div class="easyui-tabs" fit="true" border="false" >
	<div title="权限分配">
	<input type="hidden" id="checkedRoleId" >
