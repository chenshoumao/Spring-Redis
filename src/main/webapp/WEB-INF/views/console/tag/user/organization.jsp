				...
				.tree(
						{
							...
							onClick : function(node) {
								var id = node.id;
								if (id == "0") {
									document.getElementById("userIframeId").src = "${pageContext.request.contextPath}/console/tag/user/show.xsp?deparmentId="
											+ id;
								} else {
									document.getElementById("userIframeId").src = "${pageContext.request.contextPath}/console/tag/user/organizeUser.xsp?deparmentId="
											+ id;
								}
