...
<div class="easyui-accordion" data-options="fit:true,border:false">
	<div id="leftmenuTree"></div>
		   ...
		   $('#leftmenuTree').tree({   //${menu.menuId}
            url: '${pageContext.request.contextPath}/console/menu/item/sysMenuItem.action?parentItemId=0',   //&menuId=${menu.menuId}
            onBeforeExpand:function(node,param){  //${menu.menuId}
                $('#leftmenuTree').tree('options').url = "${pageContext.request.contextPath}/console/menu/item/sysMenuItem.action?parentItemId="
