			...
			<div class="gray">
				<div class="tabPanel" >
					...
					<div class="panes">
						...
						var iframecode='<iframe id="externalhot" scrolling="auto" frameborder="0" style="width:100%;height:600px" src="<%=basePath%>console/template/engine/openform/appid:be753c93-7d83-46e1-aed6-164556b6e931/formid:86af80b3-e1d9-49e8-923f-207224dd651d.xsp"></iframe>'
						...
						var iframecode='<iframe id="externalout" scrolling="auto" frameborder="0" style="width:100%;height:550px" src="<%=basePath%>console/template/engine/openform/appid:be753c93-7d83-46e1-aed6-164556b6e931/formid:6789a1c7-5127-460a-bae8-7fabb0fe55ca.xsp"></iframe>'
						document.write(iframecode)
