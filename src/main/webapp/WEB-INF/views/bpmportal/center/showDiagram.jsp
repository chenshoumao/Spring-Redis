...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/scripts/layer/skin/layer.css">
...
<body style="margin: 4px;">
	...
	<div>
		<button id="nodeinfo" style="display: none;">节点信息</button>
	</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/bpmportal/scripts/center/showDiagram.js"></script>
</body>
</html>