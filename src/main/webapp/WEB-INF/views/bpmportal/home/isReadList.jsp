...
<script>
	...
	$(function(){
		$('#page').jqPaginator({
		    totalPages: ${isReadList.pageData.totalPageCount},
		    visiblePages: 10,
		    currentPage: ${isReadList.pageData.currentPage},
			...
			<table class="table" style="text-align: center;">
		      ...
		      <thead class="acc_table_thead">
		        <tr>
		          ...
		          <th class="sapn2">传阅时间</th>
		        </tr>
		      </thead>
		      <tbody>
		        <c:forEach var="item" items="${isReadList.result}" varStatus="status">
		      	    <tr>
