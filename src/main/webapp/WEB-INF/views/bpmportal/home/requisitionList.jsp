...
<script>
	var data = '${requisitionList}';
	var appId = parent.appId;
	var formName = parent.formName;
	$(function(){
		$('#page').jqPaginator({
		    totalPages: ${requisitionList.pageData.totalPageCount},
		    visiblePages: 10,
		    currentPage: ${requisitionList.pageData.currentPage},
		    ...
		    onPageChange: function (num) {
		    	var loadTip = layer.open({
			   	...
			   	window.location.href="${pageContext.request.contextPath}/bpmportal/home/process/openRequisitionList.xsp?appId="+appId+"&formName="+formName+"&nowPage="+num+"&pageSize=10";
		    }
		});
	});
			...
			<table class="table" style="text-align: center;">
		      ...
		      <thead class="acc_table_thead">
		        <tr>
		          ...
		          <th class="sapn3">标题</th>
		          <th class="sapn3">申请号</th>
		          <th class="sapn2">申请时间</th>
		        </tr>
		      </thead>
		      <tbody>
		        <c:forEach var="item" items="${requisitionList.result}" varStatus="status">
		      	    <tr>
