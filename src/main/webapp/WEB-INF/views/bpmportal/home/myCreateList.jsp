...
<script>
	var data = '${myCreateList}';
	var appId = parent.appId;
	var formName = parent.formName;
	$(function(){
		$('#page').jqPaginator({
		    totalPages: ${myCreateList.pageData.totalPageCount},
		    visiblePages: 10,
		    currentPage: ${myCreateList.pageData.currentPage},
		    ...
		    onPageChange: function (num) {
		    	var loadTip = layer.open({
			   	...
			   	window.location.href="${pageContext.request.contextPath}/bpmportal/home/process/openMyCreateList.xsp?appId="+appId+"&formName="+formName+"&nowPage="+num+"&pageSize=10";
		    }
		});
	});
	...
	<body style="height: 100%;">
		<div class="container span9">
			<table class="table" style="text-align: center;">
		      ...
		      <tbody>
		        <c:forEach var="item" items="${myCreateList.result}" varStatus="status">
		      	    <tr>
